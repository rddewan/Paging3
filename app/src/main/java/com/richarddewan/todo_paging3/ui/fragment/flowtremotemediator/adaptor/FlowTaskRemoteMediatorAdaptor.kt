...
class FlowTaskRemoteMediatorAdaptor : PagingDataAdapter<TaskEntity, FlowTaskRemoteMediatorAdaptor.TaskRemoteMediatorViewHolder>(
    ...
    override fun onBindViewHolder(holder: TaskRemoteMediatorViewHolder, position: Int) {
        getItem(position)?.let {
            holder.onBind(it)
        }
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TaskRemoteMediatorViewHolder {
